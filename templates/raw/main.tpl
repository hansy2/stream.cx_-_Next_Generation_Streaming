...
<div class="widget">
    ...
    <div class="widget-tabs">
        <ul class="nav nav-tabs">
            <li class="active">
                <a href="#applicants"><span class="badge badge-success">21</span>&nbsp;&nbsp;&nbsp;Applicants</a>
            </li>
            <li><a href="#rsvps"><span class="badge badge-warning">46</span>&nbsp;&nbsp;&nbsp;RSVPs</a></li>
            <li><a href="#registrations"><span class="badge">215</span>&nbsp;&nbsp;&nbsp;Registrations</a></li>
        </ul>
    ...
    <div class="widget-content">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="applicants">
                ...
                <p>Pellentesque nec semper lectus. Integer id enim vitae magna ultrices interdum vel sit amet enim.
                    Suspendisse eu sapien eget ipsum ornare vestibulum. In hac habitasse platea dictumst. Morbi
                    suscipit eleifend cursus. Vivamus ac velit eget turpis pharetra placerat bibendum at risus.
                    Vestibulum a sodales mauris. Curabitur et nibh nunc.</p>
...
<div class="widget toolbar-bottom">
    ...
    <div class="widget-header">
        ...
        <div class="widget-actions">
            <input type="text" name="searchit" class="input-medium" placeholder="Search...">
        </div>
    </div>
...
<div class="widget">
    ...
    <div class="widget-header">
        ...
        <div class="widget-actions">
            <div class="btn-group">
                <a class="btn dropdown-toggle btn-small" data-toggle="dropdown" href="javascript:;">
                ...
                <div id="collapseOne" class="accordion-body in collapse">
                    <div class="accordion-inner">
                        <p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad
                            ...
                            nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt.</p>

                        <p>Vivamus ac velit eget turpis pharetra placerat bibendum at risus. Vestibulum a sodales
                            mauris. Curabitur et nibh nunc.</p>
                    </div>
                </div>
            </div>
            <div class="accordion-group">
                ...
                <div id="collapseTwo" class="accordion-body collapse">
                    <div class="accordion-inner">
                        <p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad
                            squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa
                            nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqu.</p>
            ...
            <div class="accordion-group">
                ...
                <div id="collapseThree" class="accordion-body collapse">
                    <div class="accordion-inner">
                        <p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad
                            squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa
                            nesciunt laborum eiusmod. Brunch 3.</p>
